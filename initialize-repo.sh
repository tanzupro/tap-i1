...
echo
echo Continue to create GitHub TAP GitOps Repo tap-i1
echo     https://github.com/tanzupro/tap-i1
echo
...
git add .
git commit -am "."
gh repo create tap-i1 --private
git remote add origin https://github.com/tanzupro/tap-i1
git branch -M main
